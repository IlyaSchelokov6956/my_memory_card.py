...
h_main_2.addWidget(grpbox_answer)
...
grpbox_answer.setLayout(h_grpbox)
...
questions = [
    ...
    Question('Сколько 3 градусов122?', '10', '-13210', '-19326', '5000')
]
...
def get_procent(score):
    ...
    result += 'вопросов из ' + str(questions) + '\n'
    return result
